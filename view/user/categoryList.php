...
<div class="wrapper" style="background: rgba(202, 83, 63, 0.27); color: #630b0b;">
    ...
    <div class="container">
        ...
        foreach($subcategoryList as $subcategory){
            ...
            <div class="row">
                <a href="subCategoryItemDisplay.php?id=<?php echo $subcategory['id']?>&subcat=<?php echo $subcategory['sub_category_name']?>" <h3 id="catagory" style="font-family: 'Pacifico', cursive;"><?php echo $subcategory['sub_category_name'] ?></h3></a>
                <div class="clearfix">
                    <div id="<?php echo $subcategory['sub_category_name'] ?>" class="carousel slide" data-interval="false">
                        ...
                        <a class="left carousel-control" href="#<?php echo $subcategory['sub_category_name'] ?>" role="button" style="width: 0px;" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left slider"></span>
                        </a>
                        <a class="right carousel-control" href="#<?php echo $subcategory['sub_category_name'] ?>" style="width: 0px;" role="button" data-slide="next">
